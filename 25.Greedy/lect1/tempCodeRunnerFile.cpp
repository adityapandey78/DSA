...
int main(){
    ...
    int m, n;
    cout << "Enter m (columns) and n (rows): ";
    cin >> m >> n;
    
    // Declare vectors properly
    vector<ll> horizontal, vertical;
    
    // Read vertical cut costs (m-1 cuts for m columns)
    cout << "Enter " << m-1 << " vertical cut costs: ";
    for(int i = 0; i < m - 1; i++){
        int x;
        cin >> x;
    ...
    // Read horizontal cut costs (n-1 cuts for n rows)
    cout << "Enter " << n-1 << " horizontal cut costs: ";
    for(int i = 0; i < n - 1; i++){
        int x;
        cin >> x;
    ...
    cout << "Minimum cost: " << minCostToBreak(n, m, vertical, horizontal) << "\n";
